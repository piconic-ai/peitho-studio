...
## [v0.1.0](https://github.com/piconic-ai/peitho-studio/commits/v0.1.0) - 2026-09-15
...
- Upgrade BarefootJS to 0.35.7, fixing the StatusBar ternary bug by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/54
- Harden implement-todo's test gate and Pullfrog notify gate by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/57
- Spike: drive real WKWebView window via tauri-plugin-playwright by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/56
- Fix e2e-tauri welcome test: getByText/getByRole broken against the real window by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/58
- Visible click feedback for Present and opening a deck by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/55
- Optimize dependencies in dev builds to speed up the first open_deck by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/59
- Warm up the renderer with recent decks at launch by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/60
- Refresh open_deck timing notes after the cold-start fixes by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/62
- Show skip status as a badge over the slide thumbnail by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/63
- Switch between same-base deck variants (deck.md / deck.ja.md) by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/64
- Explain why a layout doesn't fit the slide before it's chosen by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/65
- Edit section times with minutes/seconds spinners by @kfly8 in https://github.com/piconic-ai/peitho-studio/pull/66
