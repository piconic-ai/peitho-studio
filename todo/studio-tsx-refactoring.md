...
設計担当: Fable(Plan)。2025年着手、`git log`で経緯を追える
(`fe4aa3f`, `89a3e87`が直接の動機になった2バグ)。
...
| I | 通知/デバッグ | `statusMessage`, `errorMessage`, `errorMessageCopied` | `copyErrorMessage`, 自動消去effect(254); TEMPORARY: `rectToPlain`, `scanColumn`, `scanRow`, `copyThumbnailDebugSnapshot` | `navigator.clipboard` |
